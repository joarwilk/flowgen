...
declare export function promisify<TResult>(
  fn: (callback: (err: ?ErrnoError, result: TResult) => void) => void,
): () => Promise<TResult>;
declare export function promisify(
  fn: (callback: (err: ?ErrnoError) => void) => void,
): () => Promise<void>;
declare export function promisify<T1, TResult>(
  fn: (arg1: T1, callback: (err: ?ErrnoError, result: TResult) => void) => void,
): (arg1: T1) => Promise<TResult>;
declare export function promisify<T1>(
  fn: (arg1: T1, callback: (err: ?ErrnoError) => void) => void,
): (arg1: T1) => Promise<void>;
declare export function promisify<T1, T2, TResult>(
  fn: (
    arg1: T1,
    arg2: T2,
    callback: (err: ?ErrnoError, result: TResult) => void,
  ) => void,
): (arg1: T1, arg2: T2) => Promise<TResult>;
declare export function promisify<T1, T2>(
  fn: (arg1: T1, arg2: T2, callback: (err: ?ErrnoError) => void) => void,
